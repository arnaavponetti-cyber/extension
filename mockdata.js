...
export const mockSustainabilityScores = {
  "amazon.com": {
    overall: "yellow",
    score: 65,
    factors: {
...
export const mockAlternatives = [
  ...
  },
  {
    ...
    sustainabilityScore: {
      ...
      reasoning:
        "Bamboo fiber is naturally antibacterial and biodegradable. Sustainable farming practices."
    },
...
export const mockRewards = [
  ...
  },
  {
    ...
    title: "₹500 Cashback",
    description:
      "Get ₹500 cashback when you switch to sustainable alternatives",
...
export function getSustainabilityScore(url) {
...
export function getAlternatives(count = 2) {
